...
export type BriefTemplateId = 'ecom' | 'agc' | 'ugc';
 ...
 * one of the three real templates (Ecom Doc / AGC CSV / UGC Doc) and
 * injects the ad-type nuance block so the strategic content is tailored
